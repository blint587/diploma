...
//        Assert.AreEqual(l.getMatrixIndex(), Metrics.Length);
    ...
    //[Test]
    // public void 3rt_rootable){
    //    Quantity a (Metrics.Volume, 8.0, "m3");
    //
    //    auto l = a.ntrt(3);
    //
    //    Assert.AreEqual(l.getMatrixIndex(), Metrics.Length);
    //
    //    Assert.AreEqual(l("m"), 2.0);
    //}
    //
    //[Test]
    // public void 3rt_not_rootable){
    //    Quantity a (Metrics.Velocity, 8.0, "m s-1");
    //
    //    try {
    //        auto l = a.ntrt(3);
    //        FAIL() << "Exception was not raised";
    //    }catch (std::logic_error & le){
    //        Assert.AreEqual(le.what(), std::string("Cannot perform 3th root on 8 m s-1!"));
    //    }catch(...){
    ...
    //    Quantity l (Metrics.Length, 0, "m");
    //    Quantity t (Metrics.Time, 1, "s");
    //    Quantity a1 = l / (t * t);
    //
    ...
    //    Quantity l (Metrics.Length, 2.33, "m");
    //    Quantity t (Metrics.Time, 2.33, "s");
    ...
    //    Quantity l (Metrics.Length, 2.33, "m");
    //    Quantity l1 = l * l * l;
    //    Quantity t (Metrics.Time, 2.33, "h");
    //    Quantity vf1 = l1 / t;
    //
    //    Assert.AreEqual(vf1.getMatrixIndex(), Metrics.VolumetricFlow);
    //
    ...
    //    Quantity l (Metrics.Length, 1, "m");
    //    Quantity n (Metrics.AmountOfSubstance, 0, "mol");
    ...
    //    Quantity l (Metrics.Length, 1, "m");
    //    Quantity n (Metrics.AmountOfSubstance, 1, "mol");
    //    Quantity mc1 = n / (l * l * l);
    //
    //    Assert.AreEqual(mc1.getMatrixIndex(), Metrics.MolarConcentration);
    //
    ...
    //    Quantity l (Metrics.Length, 1, "m");
    //    Quantity m (Metrics.Mass, 2.33, "kg");
    //    Quantity t (Metrics.Time, 1, "s");
